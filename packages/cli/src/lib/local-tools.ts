...
import { toolInputSchemas, Mode, type ModeType } from "@daycode/shared";
...
function truncated(value: string, limit: number) {
...
export async function executeLocalTool(
  ...
  switch (toolName) {
    ...
    case "bash": {
      ...
      clearTimeout(timer);
      return {
        stdout: truncated(stdout, MAX_OUTPUT),
        stderr: truncated(stderr, MAX_OUTPUT),
        exitCode,
