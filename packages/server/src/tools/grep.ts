...
export function createGrepTool(cwd: string) {
  return tool({
    description: ` Search file contents using regex pattern. Returns matching lines with paths
    and line numbers. Skips hidden directories , node_modules and binary files. `,
